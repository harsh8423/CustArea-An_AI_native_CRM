...
const HowItWorks: React.FC = () => {
    ...
    // Smooth out the scroll progress with enhanced physics
    ...
    return (
        <section ref={containerRef} className="relative h-[250vh] bg-white py-12 md:py-24" id="how-it-works">
            <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
                ...
                <div className="w-full max-w-5xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row gap-4 md:gap-8 items-center h-full justify-center">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-center z-10 h-1/2 md:h-auto">
                        <div className="mb-6 md:mb-10">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-['Outfit'] font-bold mb-3 md:mb-4 text-slate-900 leading-tight">
                                Go live in <br />
                                <span className="text-blue-600">{STEPS.length} simple steps</span>
                            </h2>
                            <p className="text-sm md:text-base lg:text-base text-slate-500 max-w-sm font-['Inter']">
                            ...
                            {STEPS.map((step, index) => (
                                ...
                                >
                                    <div className="flex gap-3 md:gap-4">
                                        {/* Step Number Circle */}
                                        <motion.div
                                            className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold text-xs md:text-sm shrink-0 border-2 transition-colors duration-300 ${index === activeStep
                                        ...
                                        {/* Text Content */}
                                        <div className={`${index === activeStep ? 'pb-3 md:pb-4' : 'pb-0'} transition-all duration-300`}>
                                            <h3 className={`text-base md:text-lg lg:text-lg font-bold mb-0.5 md:mb-1 font-['Outfit'] ${index === activeStep ? 'text-slate-900' : 'text-slate-500'}`}>
                                                {step.title}
                                            </h3>
                                            ...
                                            <AnimatePresence>
                                                {index === activeStep && (
                                                    ...
                                                    >
                                                        ...
                                                        <ul className="grid grid-cols-1 gap-1 md:gap-1.5">
                    ...
                    <div className="flex w-full md:w-1/2 bg-white relative items-center justify-center p-4 overflow-hidden rounded-3xl h-1/2 md:h-auto">
                        {/* Background Decor */}
